...
const NavigationBar = () => {
  return (
    <>
      <div className="navbar--main">
        <div className="navbar--main-header">
          <Link className="navbar--main-header-style" to={"/"}>
            e-commerce
          </Link>
        </div>
        <div className="navbar--main-div-search">
        ...
        <div className="navbar--main-signin-shoppingbag">
          <p className="navbar--main-signin-item">
            <Link className="signin--button" to={"/SignIn"}>
              Sign In
            </Link>{" "}
            <i className="navbar--main-signin-icon fa-solid fa-angle-down"></i>
          </p>
          <i className="navbar--main-shoppingbag-item fa-solid fa-xl fa-bag-shopping"></i>
        </div>
      </div>
      ...
      <div className="navbar">
        <ul className="navbar--ul">
          ...
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Women"}>
              Women
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Men"}>
              Men
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Kids"}>
              Kids
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/YoungAdults"}>
              Young Adults
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Activewear"}>
              Activewear
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Home"}>
              Home
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Beauty"}>
              Beauty
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Designer"}>
              Designer
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Gift"}>
              Gift
            </Link>
          </li>
          <li className="navbar-li-items">
            <Link className="navbar--a-items" to={"/Threads"}>
              Threads
            </Link>
          </li>
        </ul>
